  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        ctx.beginPath()
        ctx.ellipse(cx, cy, ringR - i*20, (ringR - i*20) * scaleY, t * 0.3 + i, 0, Math.PI * 2)
      ...
      sphereGrad.addColorStop(0.7, 'rgba(67,20,180,0.5)')
      sphereGrad.addColorStop(1, 'rgba(10,5,40,0)')
      ctx.beginPath()
...
export default function Login() {
  ...
  const inputStyle = (field) => ({
    ...
    fontFamily: 'inherit',
    transition: 'all 0.3s',
    boxShadow: activeField === field ? '0 0 0 4px rgba(139,92,246,0.12), inset 0 0 20px rgba(139,92,246,0.03)' : 'none',
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        input:-webkit-autofill {
          -webkit-box-shadow: 0 0 0 100px #0a0515 inset !important;
        ...
        >
          ...
          <div style={{ display:'flex', flexWrap:'wrap', gap:10, justifyContent:'center' }}>
            {[
              ...
              { icon:'🎨', text:'AI-crafted design', color:'#60a5fa' },
              { icon:'📱', text:'100% responsive', color:'#34d399' },
              { icon:'🚀', text:'Export ready', color:'#f472b6' },
            ].map((pill, i) => (
              <motion.div
                key={pill.text}
      ...
      <div className="right-panel" style={{
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              ...
              boxShadow:'0 0 0 1px rgba(139,92,246,0.08), 0 48px 100px rgba(0,0,0,0.7), 0 0 80px rgba(139,92,246,0.05)',
          ...
          >
            ...
            <div style={{ marginBottom:30 }}>
              <motion.h2
                ...
                style={{ fontSize:'clamp(1.6rem,3vw,2rem)', fontWeight:800, margin:'0 0 8px', letterSpacing:'-0.035em', lineHeight:1.15 }}
              >
              ...
              <p style={{ fontSize:13.5, color:'rgba(255,255,255,0.32)', lineHeight:1.65, margin:0 }}>
                {isLogin
                  ...
                  : 'Create your account and build your first website in 10 seconds'}
              </p>
            </div>
            ...
            <div style={{ marginBottom:32 }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:8 }}>
                ...
                {isLogin && (
                  <span style={{ fontSize:12, color:'#a855f7', cursor:'pointer', fontWeight:600 }}
              ...
              <div style={{ position:'relative' }}>
                <FieldIcon>🔒</FieldIcon>
                <input
                  style={{ ...inputStyle('pass'), paddingRight:50 }}
                ...
                <button
                  ...
                  style={{ position:'absolute', right:14, top:'50%', transform:'translateY(-50%)', background:'none', border:'none', color:showPass?'rgba(139,92,246,0.8)':'rgba(255,255,255,0.25)', cursor:'pointer', fontSize:16, padding:0, lineHeight:1, transition:'color 0.2s' }}
                >{showPass ? '🙈' : '👁️'}</button>
              </div>
            </div>
            ...
            <div style={{ position:'relative', marginBottom:20 }}>
              ...
              <motion.button
                ...
                style={{
                  ...
                  borderRadius:14,
                  background:'linear-gradient(135deg,#9333ea,#6d28d9 50%,#4f46e5)',
                  color:'white', fontWeight:700, border:'none',
                  cursor:loading?'not-allowed':'pointer',
                  fontSize:15, fontFamily:'inherit',
                  opacity:loading?0.85:1, transition:'all 0.25s',
              ...
              >
                {loading
                  ? <><SpinIcon />{isLogin ? 'Signing in…' : 'Creating account…'}</>
        ...
        <p style={{ marginTop:20, fontSize:11.5, color:'rgba(255,255,255,0.12)', textAlign:'center' }}>
          ...
          <span style={{ color:'rgba(168,85,247,0.45)', cursor:'pointer' }}>Terms</span>{' '}&{' '}
          <span style={{ color:'rgba(168,85,247,0.45)', cursor:'pointer' }}>Privacy Policy</span>
        </p>
      </div>
    </div>
  )
...
function FieldIcon({ children }) {
  return (
    <span style={{ position:'absolute', left:15, top:'50%', transform:'translateY(-50%)', fontSize:15, pointerEvents:'none', zIndex:1 }}>
      {children}
    </span>
  )
}
